...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleMissingParam(
        ...
        log.warn("MissingParam en {}: {}", request.getRequestURI(), ex.getParameterName());
        return buildResponse(HttpStatus.BAD_REQUEST, "Parámetro requerido ausente: " + ex.getParameterName(), request.getRequestURI());
    }
